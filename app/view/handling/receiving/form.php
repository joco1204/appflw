    ...
    <div class='box box-success'>
        <div class='box-header with-border'>
            ...
            <?php if ($idReceiving == '0'){ 
                echo "<b>ADD NEW RECEIVING</b>";
            }else{  
                echo "<b>RECEIVING: ".$idReceiving."</b>";
            } ?>
            </h3>
        </div>
        <div class='box-body'>
                ...
                <form id="receiving_form" role="form"" autocomplete="off">
                            ...
                            <div class="panel panel-success">
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <input type="number" class="form-control" name="awb_number" id="awb_number" placeholder="AWB Master" required="">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <input type="number" class="form-control" name="awb_hija" id="awb_hija" placeholder="AWB Hija" required="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row"> 
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <input type="number" class="form-control" name="awb_number" id="awb_number" placeholder="AWB Nieta" required="">
                                            </div>
                                        </div>  
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <input type="number" class="form-control" name="pieces_master" id="pieces_master" placeholder="Pieces Master" readonly>    
                                            </div>
                                         </div>
                                    </div>
                                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-12 text-center">
                            ...
                            <button type="button" class="btn btn-default" onclick="javascript: pageContent('handling/receiving/index');">Cancel</button>
                        </div>
                    </div>
                </form>
            </section>
...
<?php  if($idReceiving == '0'){ 
    echo '<script src="../../js/receiving/receivingCreate.js"></script>';
    echo '<script src="../../js/receiving/receivingCreateLines.js"></script>';
}else{  
    echo '<script src="../../js/receiving/receivingEdit.js"></script>';
} ?>
